...
C:/ti/tirtos_msp43x_2_20_00_06/products/bios_6_46_00_23/packages/iar/targets/arm/ITarget.xs:
package.mak: C:/ti/tirtos_msp43x_2_20_00_06/products/bios_6_46_00_23/packages/iar/targets/arm/ITarget.xs
C:/ti/tirtos_msp43x_2_20_00_06/products/bios_6_46_00_23/packages/iar/targets/arm/package.xs:
package.mak: C:/ti/tirtos_msp43x_2_20_00_06/products/bios_6_46_00_23/packages/iar/targets/arm/package.xs
...
iar.targets.arm.M4F.rootDir ?= E:/Programs/IAR/ARM/arm
iar.targets.arm.packageBase ?= C:/ti/tirtos_msp43x_2_20_00_06/products/bios_6_46_00_23/packages/iar/targets/arm/
...
.dlls,rm4f .dlls: 5.prm4f

-include package/cfg/5_prm4f.mak
-include package/cfg/5_prm4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/5_prm4f.dep
endif
5.prm4f: package/cfg/5_prm4f.xdl
	@


ifeq (,$(wildcard .libraries,rm4f))
5.prm4f package/cfg/5_prm4f.c: .libraries,rm4f
endif

package/cfg/5_prm4f.c package/cfg/5_prm4f.h package/cfg/5_prm4f.xdl: override _PROG_NAME := 5.xrm4f
package/cfg/5_prm4f.c: package/cfg/5_prm4f.cfg
package/cfg/5_prm4f.xdc.inc: package/cfg/5_prm4f.xdl
package/cfg/5_prm4f.xdl package/cfg/5_prm4f.c: .interfaces

clean:: clean,rm4f
	-$(RM) package/cfg/5_prm4f.cfg
	-$(RM) package/cfg/5_prm4f.dep
	-$(RM) package/cfg/5_prm4f.c
	-$(RM) package/cfg/5_prm4f.xdc.inc

clean,rm4f::
	-$(RM) 5.prm4f
.executables,rm4f .executables: 5.xrm4f

5.xrm4f: |5.prm4f

-include package/cfg/5.xrm4f.mak
5.xrm4f: package/cfg/5_prm4f.orm4f 
	$(RM) $@
	@$(MSG) lnkrm4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	LC_ALL=C $(iar.targets.arm.M4F.rootDir)/bin/ilinkarm -o E:/Projects/ARM/5/Debug/Exe/5.out --map E:/Projects/ARM/5/Debug/List/5.map --log libraries,initialization,redirects,veneers --log_file E:/Projects/ARM/5/Debug/List/5.log --config E:/Projects/ARM/5/5_MSP_EXP432P401R.icf -f E:/Projects/ARM/5/configPkg/linker.cmd c:/ti/tirtos_msp43x_2_20_00_06/products/msp432_driverlib_3_21_00_05/driverlib/MSP432P4xx/ewarm/msp432p4xx_driverlib.a --silent --cpu=Cortex-M4F --entry=__iar_program_start --redirect _Printf=_PrintfSmall --redirect _Scanf=_ScanfSmall --entry __iar_program_start --vfe --silent -o $@ package/cfg/5_prm4f.orm4f -f package/cfg/5_prm4f.xdl  --semihosting=iar_breakpoint  --cpu=Cortex-M4F --map $(XDCCFGDIR)/$@.map  --redirect _Printf=_PrintfSmall --redirect _Scanf=_ScanfSmall 
	

5.test test,rm4f test: 5.xrm4f.test

5.xrm4f.test:: 5.xrm4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 5.xrm4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.5.xrm4f, ) 
endif
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
5_prm4f.orm4f,copy : package/cfg/5_prm4f.orm4f
5_prm4f.srm4f,copy : package/cfg/5_prm4f.srm4f
